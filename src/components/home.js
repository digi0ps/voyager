        ...
        <div className="columns">
          <div className="column is-4 is-offset-4 extra-padding currently-working monospace">
            ...
            <div className="content">
              ...
              <p>I also <a id="fluff" href="https://www.medium.com/@jeremyphilemon" className="blog-color">write for my blog</a>, sometimes, and also post photos on <a href="https://www.instagram.com/jeremyphilemon98" className="has-text-danger">instagram</a>. When I'm not studying, I work on open source projects and share my code with the world on <a href="https://github.com/jeremyphilemon" className="has-text-dark">github</a>, and spend the rest of my time lurking around <span className="reddit-color">reddit</span> and learning new ways to actively make myself better at adulting.</p>
