        ...
        <nav className="level is-mobile">
          ...
          <div className="level-item has-text-centered">
            <div>
              ...
              <a href="https://www.medium.com/@jeremyphilemon" id="fluff" className="has-text-dark"><Icon.Book /></a>
            </div>
          </div>
          <div className="level-item has-text-centered">
            <div>
        ...
        <div className="columns">
          <div className="column is-4 is-offset-4 extra-padding currently-working monospace">
            ...
            <div className="content">
              ...
              <p>I also write <a id="fluff" href="/fluff">stuff</a>, sometimes, and also post photos on <a href="https://www.instagram.com/jeremyphilemon98" className="has-text-danger">instagram</a>. When I'm not studying, I work on open source projects and share my code with the world on <a href="https://github.com/jeremyphilemon" className="has-text-dark">github</a>, and spend the rest of my time lurking around <span className="reddit-color">reddit</span> and learning new ways to actively make myself better at adulting.</p>
        ...
        <div className="columns" style={{display: this.state.changelog ? 'inherit' : 'none'}}>
          {
            this.state.changelogList.map((changelog, id)=>{
              return <Changelog key={id} id={changelog.pk} title={changelog.title} description={changelog.description} date={changelog.date} />;
            })
          }
        </div>
